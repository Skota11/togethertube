...
export default function Home() {
  return (
    <main className='max-w-screen-lg m-auto p-4'>
      <h1 className='text-lg mb-12'><FontAwesomeIcon icon={faPlus} className='mr-2' />部屋を立てる</h1>
      <Link href="create" className='my-8 rounded-full border-2 p-4 text-lg border-current' ><FontAwesomeIcon icon={faPlus} className='mr-2' />部屋を立てる</Link>
      <hr className='my-12' />
